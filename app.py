...
from methods import radial_velocity
...
# @app.route('/find/<sec>', methods=['POST'])
# def find(sec):
#     if request.method == 'POST':
#         # Retrieve values from the form
#         radioSignal = request.form['radioSignal']
#         radio = radial_velocity.confirm_exoplanet(radioSignal)
